...
ggplot(dt.meta.pcs, aes(x=PC2, y=PC3))+
  geom_point(aes(color=Organ, shape = Age),size=3)+
  ...
  theme(legend.position = 'none',
        axis.text = element_text(size=20,face='bold',color='gray40'),
        axis.title = element_text(size=20,face='bold'),
        legend.title = element_text(size=20,face='bold'),
        legend.text = element_text(size=20,face='bold',color='gray40'))
  ggsave('./charts/Fig1b.PCA_PC23.pdf', width = 6, height =6)
...
#PC1-PC2
  ggplot(dt.meta.pcs, aes(x=PC1, y=PC2))+
    ...
    theme(legend.position = 'none',
          ...
          legend.title = element_text(size=20,face='bold'),
          legend.text = element_text(size=20,face='bold',color='gray40'))
  ggsave('./charts/Fig1c.PCA_PC12.pdf', width = 6, height = 6)
