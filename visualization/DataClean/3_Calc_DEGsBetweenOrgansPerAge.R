...
exprMat.rawCount <- readRDS('./RDS/exprMat/exprMat_rawcount_r604c318.rds')
...
exprMat.rawCount <- readRDS('./RDS/exprMat/exprMat_novel_count_r270c320.rds')
...
saveRDS(dt.DEGanaly.lowFilt,'./RDS/Novel_DEG_OrganPerAge_org.rds')
saveRDS(dt.results,'./RDS/Novel_DEG_OrganPerAge_combine.rds')
